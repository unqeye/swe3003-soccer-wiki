...
<html>
    ...
    <body>
        ...
        <div style="text-align: center; margin: 10px">
            <button onclick="location.href='country_new.php'"
                    style="border: 0px; width: 170px; padding: 10px; font-size: 20px; background-color: #000080; color: #FFFFFF">
                국가 등록
            </button>
            <button onclick="location.href='league_new.php'"
                    style="border: 0px; width: 170px; padding: 10px; font-size: 20px; background-color: #000080; color: #FFFFFF">
                리그 등록
            </button>
            <button onclick="location.href='team_new.php'"
                    style="border: 0px; width: 170px; padding: 10px; font-size: 20px; background-color: #000080; color: #FFFFFF">
                팀 등록
            </button>
            <button onclick="location.href='manager_new.php'"
                    style="border: 0px; width: 170px; padding: 10px; font-size: 20px; background-color: #000080; color: #FFFFFF">
                감독 등록
            </button>
            <button onclick="location.href='player_new.php'"
                    style="border: 0px; width: 170px; padding: 10px; font-size: 20px; background-color: #000080; color: #FFFFFF">
                선수 등록
            </button>
        </div>
