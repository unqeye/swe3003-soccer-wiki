                ...
                <tbody>
                    ...
                    <?php
                        while ($row = mysqli_fetch_row($result)) {
                            echo "<tr>";
                            echo "<td>" . $row[0] . "</td>";
                            echo "<td><a href='country_info.php?c_id=" . $row[0] . "'>";
                                echo "<img src='https://futhead.cursecdn.com/static/img/19/nations/" . $row[0] . ".png' width='auto' height='15'>";
                                echo " " . $row[1];
                            echo "</a></td>";
                            echo "</tr>";
                        }
